    ...
    do
    {
        ...
        switch (choice)
        {
            ...
            case 'R': test.remove_current( );
                      ...
                      break;
            case 'T': cout << "Sum is " << summation(test) << '.' << endl; // added functionality, print sum
                      break;
            case 'M': cout << "Mean is " << test.mean( ) << '.' << endl; // added functionality, print mean
                      break;
            case 'D': cout << "StDev is " << test.standardDeviation( ) << '.' << endl; // added functionality, print st dev
                      break;
...
// Library facilities used: iostream.h
{
    ...
    cout << " T   Print the sum using summation( ) function" << endl; // added functionality
    cout << " M   Print the mean using mean( ) function" << endl; // added functionality
    cout << " D   Print the standard deviation using standardDeviation( )" << endl; // added functionality
